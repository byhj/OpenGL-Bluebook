...
layout (location = 1) in vec3 velocity;   // This is the current velocity of the vertex
layout (location = 2) in ivec4 connection;  // This is our connection vector

// This is a TBO that will be bound to the same buffer as the position_mass input attribute
...
uniform float k = 7.1;  // The global spring constant


const vec3 gravity = vec3(0.0, -0.08, 0.0);  // Gravity
uniform float c = 2.8;   // Global damping constant
