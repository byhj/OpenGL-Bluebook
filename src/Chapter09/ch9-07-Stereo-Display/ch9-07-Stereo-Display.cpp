...
class stereo_app : public byhj::Application
{
public:
    stereo_app()
        : view_program(0),
...
CALL_MAIN   (stereo_app);

void stereo_app::v_Init()
{
    init_shader();
...
void stereo_app::v_Render()
{
    ...
    camera_proj_matrix = glm::perspective(50.0f, GetAspect(), 1.0f, 200.0f);
