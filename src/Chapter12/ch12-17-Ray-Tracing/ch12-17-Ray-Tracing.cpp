...
void raytracer_app::v_Render()
{
    ...
    glUniform1f(uniforms.aspect, 1.0 / GetAspect());
...
void raytracer_app::v_Keyboard(GLFWwindow * window, int key, int scancode, int action, int mode)
{
    if (action)
    {
        switch (key)
...
void raytracer_app::init_shader()
{
