...
class Blend: public sb6::Application
{
public:
	void init_shader();
	void init();
...
void Blend::render()
{
	...
	static const GLenum blend_func[] =  //19混合模式
	{
		GL_ZERO,
		GL_ONE,
		GL_SRC_COLOR,
	...
	{   for (int i = 0; i < num_blend_funcs; i++) 
	   {
		  ...
		  glm::mat4 mv_matrix = glm::translate(glm::mat4(1.0), glm::vec3(9.5f - x_scale * float(i),
		   ...
		   glBlendFunc(blend_func[i], blend_func[j]);  //不同的混合函数
